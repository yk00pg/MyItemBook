...
public class PlayerDataLoader {
  ...
  /**
   * ログインしたプレイヤーのアイテム図鑑データファイル（YAMLファイル）を読み込む。<br>
   * 本プラグインのデータフォルダ、データファイルの順に参照し、存在しなければ生成して取得する。<br>
   * データファイルを読み込み、データの値を取得する。<br>
  ...
  /**
   * アイテム図鑑データをルートフィールドからマップリスト形式で取得し、各フィールドの値を取得する。<br>
   * 素材とアイテムの詳細情報を紐付けて、アイテムの詳細情報マップに追加する。
   *
