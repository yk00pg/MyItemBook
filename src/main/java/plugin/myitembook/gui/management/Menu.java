...
public enum Menu {
  ...
  /**
   * メニューの項目を取得する。<br>
   * メニューが無効の場合はダークグレイで、そうでない場合は金色でメニュー項目を取得する。
   *
  ...
  /**
   * メニューの説明文を取得する。<br>
   * UNRELEASEDメニューの場合は、ダークグレイで説明文を設定する。<br>
   * その他のメニューの場合は、無効ならダークグレイで差し替えた説明文を、
   * そうでない場合は黄色で説明文を取得する。
   *
   * @param disabled     無効の場合
  ...
  /**
   * PREV、NEXTメニュー用の説明文を取得する。<br>
   * メニューが無効ならダークグレイで差し替えた説明文を、
   * そうでない場合は白色で表示している画面に合わせた文言+説明文を取得する。
   *
   * @param disabled     無効の場合
   * @param fallbackLore 無効の場合に差し替える説明文
